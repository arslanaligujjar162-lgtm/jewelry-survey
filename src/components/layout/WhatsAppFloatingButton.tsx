...
/**
 * Persistent chat-bubble entry point to WhatsApp, present on every page —
 * the same pattern as a live-chat bubble, pointed at the channel this
 * brand actually sells and supports through.
 */
