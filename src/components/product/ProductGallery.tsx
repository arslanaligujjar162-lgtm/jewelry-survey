...
export function ProductGallery({ images, productName }: { images: string[]; productName: string }) {
  ...
  return (
    <div>
      <div className="aspect-square overflow-hidden rounded-2xl bg-brand-sky-light">
        <Image
          src={images[active]}
        ...
        <div className="mt-3 flex gap-2">
          {images.map((img, i) => (
            <button
              ...
              className={`h-16 w-16 overflow-hidden rounded-lg border-2 bg-brand-sky-light transition ${
